    ...
    public mostrar() {
        initComponents();
            ...
            Thread.sleep(2000);
                ...
                jLabel1.setText(agregar.guardar[i].numero);
                jLabel2.setText(agregar.guardar[i].nombre);
                jLabel3.setText(agregar.guardar[i].direccion);
                jLabel4.setText(agregar.guardar[i].correo);
